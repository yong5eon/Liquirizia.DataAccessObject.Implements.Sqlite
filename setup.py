...
PKG = 'Liquirizia.DataAccessObject.Implements.Sqlite'
SRC = 'src'
EXCLUDES = []
DESC = 'Sqlite Data Access Object for Liquirizia',
WHO = 'Heo Yongseon'
...
setup(
	...
	classifiers=[
		...
		'Application Framework :: Liquirizia :: DataAccessObject :: Sqlite',
	],
	install_requires=[
